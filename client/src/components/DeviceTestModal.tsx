...
import { X, Camera, Mic, Monitor, PlayCircle, StopCircle, CheckCircle, AlertTriangle, XCircle } from 'lucide-react';
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{deviceInfo.microphone}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.792L4.617 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.617l3.766-3.792A1 1 0 019.383 3.076zM14.657 2.929a1 1 0 011.414 0A9.972 9.972 0 0119 10a9.972 9.972 0 01-2.929 7.071 1 1 0 01-1.414-1.414A7.971 7.971 0 0017 10c0-2.21-.894-4.208-2.343-5.657a1 1 0 010-1.414zm-2.829 2.828a1 1 0 011.415 0A5.983 5.983 0 0115 10a5.984 5.984 0 01-1.757 4.243 1 1 0 01-1.415-1.415A3.984 3.984 0 0013 10a3.983 3.983 0 00-1.172-2.828 1 1 0 010-1.415z" clipRule="evenodd" />
                  </svg>
                  <div>
                    <h3 className="font-medium text-gray-900">Alto-falantes</h3>
                    <p className="text-sm text-gray-500">{deviceInfo.speakers}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Compartilhamento de Tela</h3>
                    <p className="text-sm text-gray-500">Captura de tela do sistema</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <ul className="text-xs text-blue-800 space-y-1">
              <li>• <strong>Câmera</strong>: Verifique se sua imagem aparece no preview</li>
              <li>• <strong>Microfone</strong>: Fale e observe o medidor de nível</li>
              <li>• <strong>Alto-falantes</strong>: Você deve ouvir um tom quando testar</li>
              <li>• <strong>Tela</strong>: Escolha uma janela/tela para compartilhar</li>
            </ul>
          </div>
        </div>
